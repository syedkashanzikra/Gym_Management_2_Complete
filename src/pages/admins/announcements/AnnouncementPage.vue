      ...
      <div class="q-gutter-md">
        <base-section flat bordered :title="$t('generalInformation')">
          <div class="col-xs-12 col-sm-4">
            <base-label required>{{ $t("date") }}</base-label>
            <base-input v-model="announcement.date" type="date" name="date" />
            <q-checkbox
              class="q-mt-md"
              dense
          ...
          <div class="col-xs-12 col-sm-4">
            <base-label required>{{ $t("openAt") }}</base-label>
            <base-time-input
              outlined
              style="width: auto"
          ...
          <div class="col-xs-12 col-sm-4">
            <base-label required>{{ $t("closeAt") }}</base-label>
            <base-time-input
              outlined
              style="width: auto"
          ...
          <div class="col-xs-12 col-sm-12">
            <base-label required>{{ $t("note") }}</base-label>
            <base-input
              type="textarea"
              name="note"
              v-model="announcement.note"
            />
          </div>
        </base-section>
      </div>
