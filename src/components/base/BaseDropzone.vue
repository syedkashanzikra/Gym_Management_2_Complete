        ...
        <template v-if="header">
          <div dense class="row no-wrap items-center">
            <q-checkbox
              ...
              "
            />
            <div v-else class="text-h6">{{ label ?? $t("media") }}</div>
            <q-space />
            <base-btn
              v-if="selected.length"
              link
    ...
    <template v-slot:list="scope">
      ...
      <div v-else class="flex flex-center dropzone">
        <div class="text-center">
          ...
          <div class="text-grey">{{ $t("fileUploader.info") }}</div>
          <div class="text-grey">{{ $t("fileUploader.or") }}</div>
          <base-btn
            link
            color="primary"
            outline
