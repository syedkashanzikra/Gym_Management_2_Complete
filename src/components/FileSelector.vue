<template>
  <q-uploader
    ref="uploader"
    :class="{
      'full-width file-selector-uploader overflow-hidden': true,
      'inline-mode': inline,
    }"
    flat
    :multiple="false"
  ...
  >
    ...
    <template v-slot:list="scope">
                ...
                >
                  ...
                  <div class="q-pa-xs text-black flex flex-center">
                    <div class="text-center">
                      ...
                      <div>{{ $t("orDropFilesHereToUpload") }}</div>
                    </div>
                  </div>
                </q-responsive>
              </div>
      ...
      >
        ...
        >
          <div class="text-center">
            <q-icon :size="mini ? '20px' : '35px'" :name="icon"></q-icon>
            ...
            <div v-if="!mini">{{ $t("orDropFilesHereToUpload") }}</div>
          </div>
        </div>
      </div>
    </template>
