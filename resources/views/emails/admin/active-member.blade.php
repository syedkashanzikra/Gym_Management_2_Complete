...
I hope this email finds you well. I wanted to inform you that a user on our platform has been marked as <strong>Active</strong>. Here are the details:
...
<strong>Date at</strong>: {{ $date_time }}
@if ($note)
<br>
