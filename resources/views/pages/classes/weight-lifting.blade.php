        ...
        <div class="container">
            ...
            <div class="row">
                ...
                <div class="col-lg-9 col-xs-12 content-area order-lg-2">
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            ...
                            <ul class="ttm-list ttm-list-style-icon font-weight-normal ttm-list-icon-color-highlight mb-10">
                                ...
                                <li>
                                    <i class="fa fa-long-arrow-right"></i>
                                    <div class="ttm-list-li-content">NitroFIT28 fitness conduct personal Crossfit</div>
                                </li>
                            </ul>
                        </div>
                        <div class="col-md-6">
                    ...
                    <p>One of our knowledgeable NitroFIT28 fitness coaches can conduct personal Crossfit exercise sessions
                        and
