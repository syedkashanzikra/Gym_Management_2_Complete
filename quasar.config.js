...
module.exports = configure(function (/* ctx */) {
  return {
    ...
    devServer: {
      https: {
        key: path.resolve(__dirname, "_wildcard.nitrofit28.gomedia+1-key.pem"),
        cert: path.resolve(__dirname, "_wildcard.nitrofit28.gomedia+1.pem"),
      },
      port: 9001,
      open: true, // opens browser window automatically
      // host: "admin.nitrofit28.gomedia",
      proxy: {
        // Using the proxy instance
        "/api/": {
          target: "http://nitrofit28.gomedia/api/",
          secure: false,
          changeOrigin: true,
        },
      },
    ...
    capacitor: {
      ...
      appName: "NitroFIT28",
      version: "1.0",
      description: "NitroFIT28 Members App",
    },
